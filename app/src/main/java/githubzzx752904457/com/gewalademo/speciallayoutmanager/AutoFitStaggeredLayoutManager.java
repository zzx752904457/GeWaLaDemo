...
public class AutoFitStaggeredLayoutManager extends RecyclerView.LayoutManager {
    private static final String TAG = AutoFitStaggeredLayoutManager.class.getSimpleName();
    ...
    private AutoFitStaggeredLayoutSizeCalculator mSizeCalculator;

    public AutoFitStaggeredLayoutManager(Context context, AutoFitStaggeredLayoutSizeCalculator.SizeCalculatorDelegate sizeCalculatorDelegate, boolean hasHearder, int headerHeight) {
        mSizeCalculator = new AutoFitStaggeredLayoutSizeCalculator(context, sizeCalculatorDelegate, hasHearder, headerHeight);
    }
    ...
    public AutoFitStaggeredLayoutSizeCalculator getSizeCalculator() {
